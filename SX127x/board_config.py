...
class BOARD:
    ...
    DIO1 = 24   # RaspPi GPIO 17
    DIO2 = 25   # RaspPi GPIO 18
    DIO3 = 5   # RaspPi GPIO 27
    RST  = 6   # RaspPi GPIO 22
    LED  = 16   # RaspPi GPIO 13 connects to the LED and a resistor (1kohm or 330ohm)
